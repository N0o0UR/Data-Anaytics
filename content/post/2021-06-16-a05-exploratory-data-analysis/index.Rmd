...
```{r,echo = FALSE, message=FALSE, warning=FALSE}
# create_report(dataset_canada)
```

![](./report.html){width=100%}

### part 2: in this part we will analyze the data set by visually explore each indicator in a specific country 
